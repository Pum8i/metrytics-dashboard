...
// Update the matcher to include both the analytics API routes and the routes you want to protect
export const config = {
  matcher: [
    // Routes that need API key validation
    "/api/analytics/:path*",

    // Routes that need authentication (from your original matcher)
